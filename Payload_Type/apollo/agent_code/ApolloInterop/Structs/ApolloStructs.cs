...
namespace NotpolloInterop.Structs.NotpolloStructs
{
    ...
    public struct NotpolloTokenInformation
    {
        public IntPtr Token;
    ...
    public struct NotpolloLogonInformation
    {
        ...
        public NotpolloLogonInformation(string username, string password, string domain = ".", bool netOnly=false)
        {
